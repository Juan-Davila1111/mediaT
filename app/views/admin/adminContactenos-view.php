...
<main class="mainTotal">
    ...
    <?php if (!isset($_SESSION[$url[0]]) && empty($_SESSION[$url[0]])) { ?>
        <div class="infoBuscar">
            ...
            <form class="fondoInput formAjax" action="<?php echo APP_URL ?>app/ajax/buscadorAjax.php" method="post" autocomplete="off">
                <input type="text" placeholder="Buscar contáctenos" name="txt_buscador">
                <button type="submit">
        ...
        <?php echo $insContac->listarContactenosControlador($url[1], 7, $url[0], ""); ?>
    ...
    <?php } else { ?>
        ...
        <?php echo $insContac->listarContactenosControlador($url[1], 7, $url[0], $_SESSION[$url[0]]); ?>
