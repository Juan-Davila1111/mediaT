    ...
    <?php if ($_SESSION["tipo"] == "Superadministrador") { ?>
        ...
        <?php if (!isset($_SESSION[$url[0]]) && empty($_SESSION[$url[0]])) { ?>
            <div class="infoBuscar">
                ...
                <a href="<?php echo APP_URL ?>adminCrear">Crear Admin</a>

            </div>

            <?php echo $insAdmin->listarAdminControlador($url[1], 7, $url[0], ""); ?>
        ...
        <?php } else { ?>
            ...
            <?php echo $insAdmin->listarAdminControlador($url[1], 7, $url[0], $_SESSION[$url[0]]); ?>
