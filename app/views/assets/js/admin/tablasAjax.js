// Funcion para enviar los formularios por via ajax
...
function animacionCarga() {
    let cargando = document.querySelector(".centrado-cargando-loader").classList.remove("overflow");
    body = document.querySelector("body")
    body.classList.add("overflow");
    let top = document.querySelector(".right").classList.add("none");
...
function animacionFina() {
    let cargando = document.querySelector(".centrado-cargando-loader").classList.add("overflow");
    body = document.querySelector("body")
